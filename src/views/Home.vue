    ...
    <div class="pt-28 pb-5">
      <div class="logo_section px-20 pt-6">
        <div class="logo_main w-full flex flex-col justify-center items-center">
          ...
          />
          <p class="text-xl font-bold pt-2 text-[#fa3636] tracking-wide">
            手拉手公益
          </p>
        </div>
      </div>
      ...
      <section class="w-full relative py-3 px-5">
        <form @click.prevent class="py-3">
          <div
            class="flex items-center w-full relative h-12 rounded-md bg-white"
          >
            <div
          ...
          <div
            class="flex items-center w-full relative h-12 rounded-md bg-white mt-5"
          >
            <div
              class="border-none w-full h-full text-base flex justify-center items-center relative"
            >
          ...
          <div class="mt-5 flex items-center w-full relative text-base">
            <button
              ...
              native-type="submit"
              style=" background-color: #fa3636;border: none; color: #fff; height: 50px;font-size:16px;letter-spacing:1px"  > 注册 </button>
          </div>
        </form>
        <div class="mt-2">
          <div  class="py-3  w-full relative">
                <div @click="downLoad(0)" class="py-4 bg-[#fa3636] rounded text-center flex items-center justify-center space-x-4 cursor-pointer">
                    <img src="@/assets/android.svg" alt="" class="w-7 h-7">
                    <span class="font-bold pt-1 text-base tracking-wider uppercase">安卓下载一</span>
                </div>
            </div>
          <div  v-if="isAndroid" class="py-3  w-full relative">
                <div @click="downLoad(2)" class="py-4 bg-[#fa3636] rounded text-center flex items-center justify-center space-x-4 cursor-pointer">
                    <img src="@/assets/android.svg" alt="" class="w-7 h-7">
                    <span class="font-bold pt-1 text-base tracking-wider uppercase">安卓下载二</span>
                </div>
            </div>
            <div v-if="isIOS"  class="py-3  w-full relative">
                <div @click="downLoad(1)" class="py-4 bg-[#fa3636] rounded text-center flex items-center justify-center space-x-4 cursor-pointer">
